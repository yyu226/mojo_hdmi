...
xst -ifn xst.scr
move pll_40m_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\pll_40m_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc pll_40m_exdes.ucf pll_40m_exdes

echo 'Running map'
map -timing -pr b pll_40m_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm pll_40m_exdes -w routed.ncd routed.v
cd ..
